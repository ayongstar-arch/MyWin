...
const MOCK_PAYMENT_METHODS = [
    { id: 'PM1', name: 'PromptPay', accNumber: '081-234-5678', accName: 'บจก. มายวิน', icon: '📱' },
...
const PassengerApp: React.FC<PassengerAppProps> = ({ riderData }) => {
    ...
    const handleRequestRide = () => {
        ...
        if (!canAfford) {
            alert('แต้มของคุณไม่เพียงพอ กรุณาเติมเงิน');
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center space-y-8">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 text-lg leading-relaxed">
                                แอปเรียกวินที่<span className="text-mywin-blue font-bold">สะดวก</span>ที่สุด<br />
                                เชื่อมต่อพี่วิน ถึงหน้าบ้านคุณ
                            </p>
                        </div>
